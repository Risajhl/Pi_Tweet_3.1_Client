...
public class FollowersListPageFXController {
    ...
    public void update(Map<String,String> followers) {
        try {
            ...
            for (Map.Entry<String, String> entry : followers.entrySet()){
                FXMLLoader fxmlLoader=new FXMLLoader(FollowersListPageFXController.class.getResource(fxmlConfig.getFollowersComponent()));
                AnchorPane anchorPane=fxmlLoader.load();
                content.getChildren().add(anchorPane);
                FollowersComponentFXController followersComponentFXController=fxmlLoader.getController();
                followersComponentFXController.setContent(content);
                followersComponentFXController.update(entry.getKey(),entry.getValue());
                followersComponentFXController.setListener(listener);
            }
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public void back(){
        GraphicalAgent.back();
        loop.stop();
        fxControllers.setFollowersListPageFXController(null);
    }
